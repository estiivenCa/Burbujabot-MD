...
global.authFile = `KanSession`
global.authFileJB = `KanBotsitos`
...
mobile: MethodMobile, 
browser: opcion == '1' ? ['KanBot-MD', 'Edge', '2.0.0'] : methodCodeQR ? ['KanBot-MD', 'Edge', '2.0.0'] : ['Ubuntu', 'Edge', '110.0.1587.56'],
auth: {
creds: state.creds,
...
const subBotDirectory = './KanBotsitos';
if (!existsSync(subBotDirectory)) {
console.log('🚩 KanBot-MD no tiene Sub-Bots vinculados.');
return;
}
...
const mainBotAuthFile = 'KanSession';
try {
const mainBot = await connectionUpdate(mainBotAuthFile);
global.conns.push(mainBot);
console.log(chalk.bold.greenBright(`🚩  KanBot conectado correctamente.`))

await connectSubBots();
} catch (error) {
console.error(chalk.bold.cyanBright(`🍭 Error al iniciar KanBot-MD: `, error))
}
})();
